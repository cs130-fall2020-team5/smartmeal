...
* Frontend documentation can be autogenerated with [documentation.js](https://github.com/documentationjs/documentation/blob/master/docs/GETTING_STARTED.md).
  * To generate the documentation:
    1. Run: npm install -g documentation
    2. Navigate to the 'smartmeal/frontend' directory
    3. Run: documentation build src/** -f html -o docs
    4. The HTML file called index.html should now be in the 'smartmeal/docs' directory
